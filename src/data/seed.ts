...
export const seedLoans: LoanRequest[] = [
  loan({
    ...
    ext: '2145',
    email: 'budi.santoso@mitramarine.co.id',
    ...
    installedNotes: 'Boom terpasang mengelilingi area rig, kondisi baik.',
  }),
  loan({
    ...
    ext: '3301',
    email: 'andi.wijaya@pertaminahulu.co.id',
    ...
    installedNotes: 'Terpasang di sisi utara platform, dicek ulang H+1.',
  }),
  loan({
    ...
    ext: '5512',
    email: 'siti.rahma@marinelogistic.co.id',
  ...
  loan({
    ...
    ext: '4420',
    email: 'hendra.gunawan@deltasarana.co.id',
    ...
    installedNotes: 'Terpasang sepanjang flowline, perlu pengecekan ulang karena overdue.',
  }),
  loan({
    ...
    ext: '2290',
    email: 'rudi.hartono@pecikofab.co.id',
  ...
  loan({
    ...
    ext: '3388',
    email: 'yuni.kartika@tunuoffshore.co.id',
  ...
  loan({
    ...
    ext: '4901',
    email: 'fajar.nugroho@southmahakam.co.id',
    boomFunction: 'Drilling Support',
    workDescription: 'Standby boom selama well testing Sumur South-9, durasi belum bisa dipastikan',
    ...
    status: 'Pending',
    priority: 'Normal',
    notes: 'Menunggu persetujuan ENV. Tanggal selesai TBC, tergantung hasil well testing.',
  }),
  loan({
    ...
    ext: '2701',
    email: 'dewi.lestari@serangconstruction.co.id',
  ...
  loan({
    ...
    entity: 'PT Mitra Marine Services',
    ext: '2145',
    email: 'bayu.prakoso@mitramarine.co.id',
    boomFunction: 'Marine Transport',
